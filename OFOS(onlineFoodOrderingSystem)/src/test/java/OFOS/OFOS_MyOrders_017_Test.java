...
public class OFOS_MyOrders_017_Test extends Base_Test{
	@Test
	public void placeOrderFromNorthIndianRestaurant() throws Throwable {
		...
		homePage.getNorthIndianLink().click();
		test.log(LogStatus.INFO, "clicked on "+homePage.getNorthIndianLink().getText()+" link");
		try {
