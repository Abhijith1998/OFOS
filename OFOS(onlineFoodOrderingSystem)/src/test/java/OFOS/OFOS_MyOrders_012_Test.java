...
public class OFOS_MyOrders_012_Test extends Base_Test{
	@Test
	public void placeOrderFromContinentalRestaurant() throws Throwable {
		...
		homePage.getContinentalLink().click();
