...
public class OFOS_MyOrders_016_Test extends Base_Test{
	@Test
	public void placeOrderFromSouthIndianRestaurant() throws Throwable {
		...
		homePage.getSouthIndianLink().click();
		test.log(LogStatus.INFO, "clicked on "+homePage.getSouthIndianLink().getText()+" link");
		try {
