...
public class OFOS_MyOrders_014_Test extends Base_Test{
	@Test
	public void placeOrderFromChineseRestaurant() throws Throwable {
		...
		jsUtil.jsScrollIntoView(true, homePage.getChineseLink());
		homePage.getChineseLink().click();
